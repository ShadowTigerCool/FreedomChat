...
public class FreedomChat extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        if (!Boolean.getBoolean("im.evan.freedomchat.bypassprotocolcheck") && this.getServer().getUnsafe().getProtocolVersion() != 774) {
            getLogger().warning("This version of FreedomChat only supports protocol version 774 (1.21.10). Please use the appropriate version of FreedomChat for your server");
